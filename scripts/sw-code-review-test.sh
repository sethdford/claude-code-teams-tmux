...
MOCK
    ...
    sed "s|\$TEST_TEMP_DIR|$TEST_TEMP_DIR|g" "$TEST_TEMP_DIR/bin/git" > "$TEST_TEMP_DIR/bin/git.tmp" && mv "$TEST_TEMP_DIR/bin/git.tmp" "$TEST_TEMP_DIR/bin/git" && chmod +x "$TEST_TEMP_DIR/bin/git"
