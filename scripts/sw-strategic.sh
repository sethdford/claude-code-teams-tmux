...
if type policy_get_with_override >/dev/null 2>&1; then
    STRATEGIC_MAX_ISSUES=$(policy_get_with_override "STRATEGIC_MAX_ISSUES" ".strategic.max_issues_per_cycle" "5")
    STRATEGIC_COOLDOWN_SECONDS=$(policy_get_with_override "STRATEGIC_COOLDOWN_SECONDS" ".strategic.cooldown_seconds" "14400")
    STRATEGIC_STRATEGY_LINES=$(policy_get_with_override "STRATEGIC_STRATEGY_LINES" ".strategic.strategy_lines" "200")
    STRATEGIC_OVERLAP_THRESHOLD=$(policy_get_with_override "STRATEGIC_OVERLAP_THRESHOLD" ".strategic.overlap_threshold_percent" "60")
