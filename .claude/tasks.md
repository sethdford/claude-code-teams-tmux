# Tasks — Split sw-loop.sh's Iteration/Prompt-Composition Logic into scripts/lib/loop-*.sh

## Status: In Progress
Pipeline: autonomous | Branch: ci/issue-3240
...
## Notes
- Generated from pipeline plan at 2026-08-29T04:40:23Z
