...
| `scripts/sw-pipeline.sh`              |  1075 | Autonomous Feature Delivery (Idea → Production)        |
...
| `scripts/lib/pipeline-utils.sh`     |   280 | Pure utilities: format, parse, classify, rotate |
| `scripts/lib/pipeline-execution.sh` |   483 | Stage retry, self-healing, rebase               |
| `scripts/lib/pipeline-lifecycle.sh` |  1233 | Subcommands: start, resume, status, abort, list |
