...
| `shipwright pipeline watch [issue]`                | Live stage-level progress dashboard (refreshes ~5s) |
...
| `scripts/sw-pipeline-watch-test.sh`              |   181 | Real-Time Pipeline Progress Stream                |
