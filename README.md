...
<!-- Docs note: this README is the canonical entry point for Shipwright. Blocks wrapped in AUTO markers are regenerated by `shipwright docs sync` — edit the source of truth, not the generated block. -->
